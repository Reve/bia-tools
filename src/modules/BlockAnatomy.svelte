...
<div class="block-anatomy">
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <div class="card text-center">
      <div class="w-10 h-10 mx-auto mb-2 rounded-full bg-cobalt/10 flex items-center justify-center">
  ...
  <div class="mb-6">
    <div class="flex items-center justify-between mb-4">
      ...
      <button class="btn-secondary text-sm" onclick={resetBlock}>
        Reset Block
      </button>
    </div>
  ...
  <div class="card mb-6">
    ...
    <div class="bg-ink/5 rounded-lg p-4 font-mono text-sm overflow-x-auto">
